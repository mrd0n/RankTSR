...
Example output:
    ...
    +--------+------------+----------+-----------+--------+
    The percentile rank for CVE.TO is 0.80% and the CVE Score is 1.75 
    ...
    +-----------+------------+------------+-----------+------+-------+
    |    2021   | 2021-01-01 | 2021-12-31 |    0.1    | 0.80 |  1.75 |
    |    2022   | 2022-01-01 | 2022-12-31 |    0.1    | 0.70 |  1.50 |
    |    2023   | 2023-01-01 | 2023-12-31 |    0.1    | 0.40 |  0.70 |
    | 2021-2023 | 2021-01-01 | 2023-12-31 |    0.7    | 0.80 |  1.75 |
    |     -     |     -      |     -      |     -     |  -   |   -   |
    |   Total   |            |            |           |      |  1.62 |
    +-----------+------------+------------+-----------+------+-------+
